...
import ae.propertyfinder.di.component.ApplicationComponent
import ae.propertyfinder.di.component.DaggerApplicationComponent
...
class PropertyFinderApplication : MultiDexApplication(), HasActivityInjector, HasSupportFragmentInjector {
    ...
    @Inject
    lateinit var propertyFinderPreferences: PropertyFinderPreferences
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        propertyFinderPreferences.setBool(CONFIG_CHANGE_LOCALE, true)
    }
